...
var vifUnitExt = map[string]int{
	// Currency Units
	"CURRENCY_CREDIT": 0x103, // E000 00nn Credit of 10 nn-3 of the nominal ...
	"CURRENCY_DEBIT":  0x107, // E000 01nn Debit of 10 nn-3 of the nominal ...

	// Enhanced Identification
	"ACCESS_NUMBER":    0x108, // E000 1000 Access Number (transmission count)
	"MEDIUM":           0x109, // E000 1001 Medium (as in fixed header)
	"MANUFACTURER":     0x10A, // E000 1010 Manufacturer (as in fixed header)
	"PARAMETER_SET_ID": 0x10B, // E000 1011 Parameter set identification Enha ...
	"MODEL_VERSION":    0x10C, // E000 1100 Model / Version
	"HARDWARE_VERSION": 0x10D, // E000 1101 Hardware version //
	"FIRMWARE_VERSION": 0x10E, // E000 1110 Firmware version //
	"SOFTWARE_VERSION": 0x10F, // E000 1111 Software version //

	// Implementation of all TC294 WG1 requirements (improved selection ..)
	"CUSTOMER_LOCATION":           0x110, // E001 0000 Customer location
	"CUSTOMER":                    0x111, // E001 0001 Customer
	"ACCESS_CODE_USER":            0x112, // E001 0010 Access Code User
	"ACCESS_CODE_OPERATOR":        0x113, // E001 0011 Access Code Operator
	"ACCESS_CODE_SYSTEM_OPERATOR": 0x114, // E001 0100 Access Code System Operator
	"ACCESS_CODE_DEVELOPER":       0x115, // E001 0101 Access Code Developer
	"PASSWORD":                    0x116, // E001 0110 Password
	"ERROR_FLAGS":                 0x117, // E001 0111 Error flags (binary)
	"ERROR_MASKS":                 0x118, // E001 1000 Error mask
	"RESERVED":                    0x119, // E001 1001 Reserved
	"DIGITAL_OUTPUT":              0x11A, // E001 1010 Digital Output (binary)
	"DIGITAL_INPUT":               0x11B, // E001 1011 Digital Input (binary)
	"BAUDRATE":                    0x11C, // E001 1100 Baudrate [Baud]
	"RESPONSE_DELAY":              0x11D, // E001 1101 response delay time
	"RETRY":                       0x11E, // E001 1110 Retry
	"RESERVED_2":                  0x11F, // E001 1111 Reserved

	// Enhanced storage management
	"FIRST_STORAGE_NR":       0x120, // E010 0000 First storage
	"LAST_STORAGE_NR":        0x121, // E010 0001 Last storage
	"SIZE_OF_STORAGE_BLOCK":  0x122, // E010 0010 Size of storage block
	"RESERVED_3":             0x123, // E010 0011 Reserved
	"STORAGE_INTERVAL":       0x127, // E010 01nn Storage interval
	"STORAGE_INTERVAL_MONTH": 0x128, // E010 1000 Storage interval month(s)
	"STORAGE_INTERVAL_YEARS": 0x129, // E010 1001 Storage interval year(s)

	// E010 1010 Reserved
	// E010 1011 Reserved
	"DURATION_SINCE_LAST_READOUT": 0x12F, // E010 11nn Duration since last ...

	//  Enhanced tarif management
	"START_OF_TARIFF":        0x130, // E011 0000 Start (date/time) of tariff
	"DURATION_OF_TARIFF":     0x133, // E011 00nn Duration of tariff
	"PERIOD_OF_TARIFF":       0x137, // E011 01nn Period of tariff
	"PERIOD_OF_TARIFF_MONTH": 0x138, // E011 1000 Period of tariff months(s)
	"PERIOD_OF_TARIFF_YEARS": 0x139, // E011 1001 Period of tariff year(s)
	"DIMENSIONLESS":          0x13A, // E011 1010 dimensionless / no VIF

	// E011 1011 Reserved
	// E011 11xx Reserved
	// Electrical units
	"VOLTS":                          0x14F, // E100 nnnn 10 nnnn-9 Volts
	"AMPERE":                         0x15F, // E101 nnnn 10 nnnn-12 A
	"RESET_COUNTER":                  0x160, // E110 0000 Reset counter
	"CUMULATION_COUNTER":             0x161, // E110 0001 Cumulation counter
	"CONTROL_SIGNAL":                 0x162, // E110 0010 Control signal
	"DAY_OF_WEEK":                    0x163, // E110 0011 Day of week
	"WEEK_NUMBER":                    0x164, // E110 0100 Week number
	"TIME_POINT_OF_DAY_CHANGE":       0x165, // E110 0101 Time point of day ...
	"STATE_OF_PARAMETER_ACTIVATION":  0x166, // E110 0110 State of parameter
	"SPECIAL_SUPPLIER_INFORMATION":   0x167, // E110 0111 Special supplier ...
	"DURATION_SINCE_LAST_CUMULATION": 0x16B, // E110 10pp Duration since last
	"OPERATING_TIME_BATTERY":         0x16F, // E110 11pp Operating time battery
	"DATEAND_TIME_OF_BATTERY_CHANGE": 0x170, // E111 0000 Date and time of bat...
	// E111 0001 to E111 1111 Reserved

	"RSSI": 0x171, // E111 0001 RSSI
}

var vifUnitSecExt = map[string]int{
	"RELATIVE_HUMIDITY": 0x21A,
}
